...
export default function ProfilePage() {
  ...
  if (loading) {
    return (
      <div className="container-app flex min-h-[40vh] items-center justify-center text-sm text-[var(--color-text-secondary)]">
    ...
    <div className="border-b border-[var(--color-border-light)] bg-[var(--color-bg-secondary)] pb-20 pt-8">
      <div className="container-app max-w-4xl">
        <motion.div
          ...
          className="mb-8 overflow-hidden rounded-[var(--radius-xl)] border border-[var(--color-border-light)] bg-gradient-to-br from-[var(--color-primary)] via-[#3b6cff] to-[var(--color-accent-purple)] p-8 text-white shadow-[var(--shadow-lg)]"
        >
          <div className="flex flex-col gap-6 sm:flex-row sm:items-center">
            <div className="relative">
              <div className="flex size-24 items-center justify-center overflow-hidden rounded-[var(--radius-2xl)] border-4 border-white/30 bg-white/10 text-3xl shadow-[var(--shadow-md)]">
                {avatarSrc(avatarUrl) ? (
                  ...
                  <UserRound className="size-12 opacity-90" />
                )}
              </div>
              <label className="absolute -bottom-1 -right-1 flex size-9 cursor-pointer items-center justify-center rounded-[var(--radius-md)] bg-white text-[var(--color-primary)] shadow-[var(--shadow-md)]">
                {uploading ? (
            ...
            <div>
              ...
              <p className="mt-2 text-sm text-white/85">
                {user.username} · {user.userType === "student" ? "学生" : user.userType}
              </p>
            </div>
          </div>
        </motion.div>
        ...
        <Tabs.Root value={tab} onValueChange={setTab}>
          <Tabs.List className="mb-8 flex flex-wrap gap-2 border-b border-[var(--color-border-light)] pb-1">
            {[
            ...
            >
              <Card className="border-[var(--color-border-light)] bg-[var(--color-surface)]">
                <CardHeader>
                  ...
                  <CardDescription>更新你的联系方式与学籍信息</CardDescription>
                </CardHeader>
                <CardContent>
            ...
            >
              <Card className="border-[var(--color-border-light)] bg-[var(--color-surface)]">
                <CardHeader>
                  ...
                  <CardDescription>请使用安全的新密码，避免与常用网站相同</CardDescription>
                </CardHeader>
                <CardContent>
